...
import 'excuses_confirmation.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Container(
          child: Text(
            'Onay Bekleyen Mazeretler',
            style: TextStyle(color: Colors.white),
          ),
        ),
      ),
      body: ExcusesPageBody(),
    );
  }
}

class ExcusesPageBody extends StatefulWidget {
  ExcusesPageBody();

  @override
  _ExcusesPageBodyState createState() => _ExcusesPageBodyState();
}

class _ExcusesPageBodyState extends State<ExcusesPageBody> {
      ...
      return StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.data.docs.length == 0) {
            return Center(
              child: Text('Onay bekleyen mazeret bulunmamaktadır'),
            );
          }
      ...
      onTap: () {
        Navigator.push(
            ...
            new MaterialPageRoute(
                builder: (context) =>
                new ExcusesConfirmation(document.id)));
      },
      child: Column(
        children: [
          Padding(
